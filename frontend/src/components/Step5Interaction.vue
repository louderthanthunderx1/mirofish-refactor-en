        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat with the report agent; uses 4 tools and full MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Align real-world seed data with simulation state; deep attribution via Global/Local Memory</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based breadth-first traversal; event propagation paths and information flow topology</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query; fast lookup of node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews; parallel multi-turn dialogue with agents for opinions and mental state</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to explore the report' : 'Chat with simulated agents to learn their views' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter the question for all selected agents..."
                rows="3"
              ></textarea>
            </div>
...
const chatHistoryCache = ref({}) // cache: report_agent, agent_0, ...
...
const renderMarkdown = (content) => {
  ...
  // Trim list item whitespace
  html = html.replace(/<\/li>\s+<li/g, '</li><li')
  // Trim after list open tag
  html = html.replace(/<ul class="md-ul">\s+/g, '<ul class="md-ul">')
  html = html.replace(/<ol class="md-ol">\s+/g, '<ol class="md-ol">')
  // Trim before list close tag
  ...
  // Trim <br> around block elements
  html = html.replace(/<br>\s*(<ul|<ol|<blockquote)/g, '$1')
  html = html.replace(/(<\/ul>|<\/ol>|<\/blockquote>)\s*<br>/g, '$1')
  // Remove <p><br> before block
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Collapse consecutive <br>
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Trim <br> before <p> after block
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix ol numbering when split by paragraphs
...
const sendToAgent = async (message) => {
  ...
  addLog(`To ${selectedAgent.value.username}: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    // res.data.result.results: { "twitter_0": {...}, "reddit_0": {...} }
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // Convert to array, prefer reddit
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prefer reddit, then twitter
...
const submitSurvey = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      // res.data.result.results: object by platform_key
      const resultData = res.data.result || res.data
      const resultsDict = resultData.results || resultData
...
const loadReportData = async () => {
  ...
  try {
    ...
    addLog(`Load report failed: ${err.message}`)
  }
}
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    addLog(`Load report log failed: ${err.message}`)
  }
}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    addLog(`Load agents failed: ${err.message}`)
  }
}
...
// Lifecycle
onMounted(() => {
  addLog('Step5 Deep interaction init')
  loadReportData()
  loadProfiles()
...
/* Left Panel - Report style (same as Step4Report) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* Fix ol numbering with CSS counter */
.message-text {
