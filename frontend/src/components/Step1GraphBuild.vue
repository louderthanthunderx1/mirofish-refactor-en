    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Ontology</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes documents and simulation requirement to extract seeds and generate ontology
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Chunk documents and build knowledge graph (Zep/Neo4j); extract entities and relations; form temporal memory
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph build complete. Go to environment setup next.</p>
          <button 
            class="action-btn" 
...
// Go to env setup: create simulation and navigate
...
alert('Create simulation failed: ' + (res.error || 'Unknown error'))
    ...
    alert('Create simulation error: ' + err.message)
  } finally {
