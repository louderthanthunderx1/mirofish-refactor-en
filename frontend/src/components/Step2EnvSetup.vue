    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create simulation instance and load world parameters template
          </p>
          ...
          <div v-if="simulationId" class="info-card">
            ...
            <div class="info-row">
              ...
              <span class="info-value mono">{{ taskId || 'Async task done' }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 1" class="badge success">Done</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            Use knowledge graph to extract entities and relations, initialize agents with unique behavior and memory from real-world seeds
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">Agents so far</span>
            </div>
            <div class="stat-card">
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            ...
            <div class="profiles-list">
              ...
              >
                ...
                <p class="profile-bio">{{ profile.bio || 'No bio' }}</p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Dual-platform config</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 2" class="badge success">Done</span>
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM sets time flow, recommendation algo, active hours, posting frequency, and event triggers from simulation requirement and seeds
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              ...
              <div class="time-periods">
                <div class="period-item">
                  <span class="period-label">Peak</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.peak_hours?.join(':00, ') }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.peak_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">Work</span>
                ...
                >
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        <span class="param-label">Comments/h</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Recommendation algo</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 3" class="badge success">Done</span>
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Generate initial events and hot topics from narrative direction to bootstrap the simulation
          </p>
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="initial-posts-section">
              <span class="box-label">Initial activation ({{ simulationConfig.event_config.initial_posts.length }})</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase >= 4" class="badge processing">Ready</span>
            <span v-else class="badge pending">Waiting</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <p class="description">Environment is ready. You can start the simulation.</p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish plans <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> h real time, <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> min per round</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>~{{ Math.round(customMaxRounds * 0.6) }} min for 100 agents</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        ~{{ Math.round(autoGeneratedRounds * 0.6) }} min for 100 agents
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">First run? Switch to Custom to use fewer rounds for a quick preview ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-section">
            ...
            <p class="section-bio">{{ selectedProfile.bio || 'No bio' }}</p>
          </div>

          <!-- Topics -->
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">Seed topics</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">Persona background</span>
            
            <!-- Persona dimensions -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">Event experience</span>
                <span class="dim-desc">Full behavior trajectory in this event</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behavior profile</span>
                <span class="dim-desc">Style and preferences</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Memory</span>
                <span class="dim-desc">Memory formed from real-world seeds</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Social network</span>
                <span class="dim-desc">Links and interaction graph</span>
              </div>
            </div>
...
const props = defineProps({
  simulationId: String,  // from parent
  projectData: Object,
  graphData: Object,
  systemLogs: Array
})
...
// State
const phase = ref(0) // 0: init, 1: profiles, 2: config, 3: done
...
// Log dedup: last key message
let lastLoggedMessage = ''
let lastLoggedProfileCount = 0
let lastLoggedConfigStage = ''

// Rounds config
const useCustomRounds = ref(false) // use auto rounds by default
const customMaxRounds = ref(40)   // default 40 rounds
...
watch(currentStage, (newStage) => {
  if (newStage === '生成Agent人设' || newStage === 'generating_profiles') {
    ...
    phase.value = 2
    // Config generation phase, start polling
    if (!configTimer) {
      addLog('Generating dual-platform config...')
      startConfigPolling()
    }
  } else if (newStage === '准备模拟脚本' || newStage === 'copying_scripts') {
    phase.value = 2 // still config phase
  }
})

// Compute auto rounds from config
const autoGeneratedRounds = computed(() => {
  if (!simulationConfig.value?.time_config) {
    return null // config not ready
  }
  ...
  // Min 40 rounds for slider range
...
// Total seed topics across profiles
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    // Custom rounds: pass max_rounds
    params.maxRounds = customMaxRounds.value
    addLog(`Starting simulation, custom rounds: ${customMaxRounds.value}`)
  } else {
    // Use auto rounds, no max_rounds
    addLog(`Starting simulation, auto rounds: ${autoGeneratedRounds.value}`)
  }
...
const startPrepareSimulation = async () => {
  ...
  phase.value = 1
  addLog(`Simulation created: ${props.simulationId}`)
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Preparation already done, reusing')
      ...
      // Set expected agent count from prepare
      if (res.data.expected_entities_count) {
        expectedTotal.value = res.data.expected_entities_count
        addLog(`Read ${res.data.expected_entities_count} entities from graph`)
        if (res.data.entity_types && res.data.entity_types.length > 0) {
          addLog(`  └─ Types: ${res.data.entity_types.join(', ')}`)
        }
      }
      
      addLog('Polling prepare progress...')
      // Start progress poll
      startPolling()
      // Start realtime profiles fetch
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Update only when API returns valid value
      ...
      // Log profile progress on count change
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        addLog(`→ Profile ${currentCount}/${total}: ${profileName} (${latestProfile?.profession || 'Unknown'})`)
...
const fetchConfigRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Log config stage (dedup)
      if (data.generation_stage && data.generation_stage !== lastLoggedConfigStage) {
        lastLoggedConfigStage = data.generation_stage
        if (data.generation_stage === 'generating_profiles') {
          addLog('Generating agent config...')
        } else if (data.generation_stage === 'generating_config') {
          addLog('Calling LLM for simulation config...')
        }
      }
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          ...
          addLog(`  ├─ Duration: ${data.summary.simulation_hours}h`)
        ...
        if (data.config.time_config) {
          ...
          addLog(`Time: ${tc.minutes_per_round} min/round, ${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)} rounds`)
        }
        ...
        stopConfigPolling()
        phase.value = 4
        addLog('✓ Environment ready, you can start simulation')
...
const loadPreparedData = async () => {
  phase.value = 2
  addLog('Loading existing config...')

  // Fetch profiles once more
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        if (res.data.summary) {
          ...
          addLog(`  ├─ Duration: ${res.data.summary.simulation_hours}h`)
...
onMounted(() => {
  // Auto-start prepare flow
  if (props.simulationId) {
    addLog('Step2 Environment setup init')
