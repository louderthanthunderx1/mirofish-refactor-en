    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a piece of text, <span class="highlight-bold">MiroFish</span> can automatically build a parallel world of up to <span class="highlight-orange">millions of agents</span> from real-world seeds. Inject variables from a god's-eye view and find<span class="highlight-code">“local optima”</span>
            </p>
            <p class="slogan-text">
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Seed extraction & memory injection & GraphRAG</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity/relation extraction & persona generation & config</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Parallel simulation & demand parsing & temporal memory</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent tools & deep interaction with simulated world</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any agent & with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction in natural language (e.g. what happens if X announces Y?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation: navigate first, API called on Process page
