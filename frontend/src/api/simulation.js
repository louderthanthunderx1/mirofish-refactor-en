...
/**
 * Get simulation profiles (realtime)
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Get simulation config (realtime)
 * @param {string} simulationId
 */
...
/**
 * Get run status detail (with recent actions)
 * @param {string} simulationId
 */
...
/**
 * Get simulation history (with project details) for timeline
 * @param {number} limit
 */
