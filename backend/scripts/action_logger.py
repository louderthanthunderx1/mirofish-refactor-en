"""
Action logger for OASIS simulation: logs each agent action for backend monitoring.
Layout: sim_xxx/{twitter,reddit}/actions.jsonl, simulation.log, run_state.json
"""
...
class SimulationLogManager:
    """Manages simulation log files per platform."""
...
class ActionLogger:
    """Legacy action logger; prefer SimulationLogManager."""
...
def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Legacy: get global logger instance."""
